...
public class ShareniuProcessDiagramGeneratorExt extends DefaultProcessDiagramGenerator {
	...
	protected static DefaultProcessDiagramCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType,
		...
		return new ShareniuProcessDiagramCanvasExt((int) maxX + 10, (int) maxY + 10, (int) minX, (int) minY, imageType,
				activityFontName, labelFontName, annotationFontName, customClassLoader);
	}
}
